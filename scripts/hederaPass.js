...
const hederaPassDataPath = path.join(
  __dirname,
  "../",
  "results",
  "hederaPassUSD.json"
...
async function main() {
  ...
  for (let index = 0; index < 5; index++) {
    ...
    let txFee = await registerFunction(
      passContractId,
    ...
    obj["registerFunction"] = {
      [timestampRegisterFunction]: `${txFee}/${endTime - startTime}ms`,
    };
  ...
  fs.writeFileSync(hederaPassDataPath, JSON.stringify(final), null, 2);
