...
async function main() {
    ...
    for(let i = 1; i <= 5; i++){
        ...
        // const passCon: Pass = await ethers.getContractAt("Pass", "0xE5eD41c94Fb35B28D71C4ea45a7974FBfbF70e91");
        ...
        fs.writeFileSync(ethereumPassDataPath, JSON.stringify(finalValue));
